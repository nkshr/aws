...
INC_GFLAGS_DIR = $(CUR_DIR)/gflags/include
INC_GLOG_DIR = $(CUR_DIR)/glog/include
LIB_BOOST_DIR = /usr/lib/arm-linux-gnueabihf/
...
FILTER = f_base f_nmea f_cam f_camcalib f_imgshk f_misc \
	...
	f_wp_manager f_glfw_stereo_view f_stereo f_aws3_com f_aws3_ui f_state_estimator f_aws1_sim
